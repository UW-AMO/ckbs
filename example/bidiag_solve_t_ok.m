...
% -------------------------------------------------------------------
% $begin bidiag_solve_t_ok.m$$ $newlinech %$$
% $spell
%       ckbs
%       ak
%       blk
...
% $$
%
% $section ckbs_bidiag_solve_t Example and Test$$
%
% $index ckbs_bidiag_solve_t, example and test$$
% $index bidiag_solve_t, example and test$$
% $index example, bidiag_solve_t$$
% $index test, bidiag_solve_t$$
%
% $head Source Code$$
% $newlinech $$ $codep
