...
% -------------------------------------------------------------------
% $begin t_general_ok.m$$ $newlinech %$$
% $spell
%	itr
%	ko
%	nargin
...
function [ok]= t_general_ok(draw_plot)
...
N     = 200;        % number of measurement time points
...
% measurement: from second component
...
w = 1;
[xOut, info] = ckbs_t_general(g_fun, h_fun, max_itr, epsilon, xOne, z, qinv, w*rinv, params);

ok = info(end, 3) < epsilon || info(end, 1) < 1e-8;
