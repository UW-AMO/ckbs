...
% -------------------------------------------------------------------
% $begin ckbs_bidiag_solve$$ $newlinech %$$
% $spell
%       ckbs
%       blkdiag
%       ckbs_bidiag_solve
...
%
% $index ckbs_bidiag_solve$$
% $index bidiag_solve$$
%
% $index solve, block bidiagonal$$
% $index bidiagonal, block solve$$
%
% $head Syntax$$
% $codei/[/e/, /lambda/] = ckbs_bidiag_solve(/b/, /c/, /r/)/$$
%
% $head Purpose$$
...
%
% $children#
%       example/bidiag_solve_ok.m
% #$$
%
% $head Example$$
% The file $cref bidiag_solve_ok.m$$ contains an example and test of
% $code ckbs_bidiag_solve$$.
% It returns true if $code ckbs_bidiag_solve$$ passes the test
% and false otherwise.
%
% $end
% -------------------------------------------------------------------------
% --
function [e, lambda] = ckbs_bidiag_solve(c, a, r)
    %
